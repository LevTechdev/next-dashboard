...
import {
  ...
  useViewTransition,
} from "@/components/view-transition-provider";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div className="md:col-span-2 max-w-sm">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                A comprehensive business management platform with real-time
                analytics, order tracking, team collaboration, and everything
          ...
          <div className="mt-14 pt-8 border-t border-border">
            <p className="text-xs text-muted-foreground text-center">
              &copy; {new Date().getFullYear()} Dashboard Management System. All
              rights reserved.
            </p>
          </div>
        </div>
