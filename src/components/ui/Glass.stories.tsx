...
export const VengeanceGlass: StoryObj = {
  parameters: {
    docs: {
      description: {
        story:
          "Premium frosted glass panel using `.vengeance-glass`. Background: `--glass-bg`, border: `--glass-border`, blur: `24px` + `saturate(1.8)`.",
      },
    },
  },
  render: () => (
    <div className="relative w-full max-w-sm min-h-[200px] rounded-2xl bg-gradient-to-br from-indigo-500/20 via-purple-500/20 to-pink-500/20 dark:from-indigo-500/30 dark:via-purple-500/30 dark:to-pink-500/30 flex items-center justify-center p-6">
      <div className="vengeance-glass rounded-2xl p-5 w-full">
        ...
        <p className="text-xs text-gray-600 dark:text-gray-300 leading-relaxed">
          Glass surfaces adapt their transparency and saturation automatically between light and
          dark themes.
        </p>
...
export const GlassPanel: StoryObj = {
  parameters: {
    docs: {
      description: {
        story:
          "Standard glass panel using `.glass-panel`. Used for marketing navigation and overlay panels.",
      },
    },
  },
  render: () => (
...
export const VengeanceCard: StoryObj = {
  parameters: {
    docs: {
      description: {
        story:
          "Premium card with hover-lift and animated gradient border (`--glow-indigo`). Hover to see the lift and gradient shine.",
      },
    },
  },
  render: () => (
    <div className="w-full max-w-sm">
      <div className="vengeance-card p-6 rounded-xl">
        ...
        <p className="text-xs text-gray-600 dark:text-gray-300 leading-relaxed">
          Hover to lift 4px with shadow deepening. Gradient border fades in at 8% opacity (15% in
          dark mode).
        </p>
...
export const GradientBorderCard: StoryObj = {
  parameters: {
    docs: {
      description: {
        story:
          "Card with `mask-composite: exclude` gradient border. Hover to reveal the indigo→purple→blue gradient edge.",
      },
    },
  },
  render: () => (
    <div className="w-full max-w-sm">
      <div className="gradient-border-card p-6 rounded-xl">
        ...
        <p className="text-xs text-gray-600 dark:text-gray-300 leading-relaxed">
          Hover to reveal the 1px gradient border created with CSS mask-composite. Border uses
          `--glow-indigo`, `--glow-purple`, and `--glow-blue` tokens.
        </p>
        <div className="mt-4 flex gap-2">
...
export const SpotlightCard: StoryObj = {
  parameters: {
    docs: {
      description: {
        story:
          "Card with mouse-tracking radial spotlight. Move your mouse inside the card to see the highlight track its position via `--mouse-x` / `--mouse-y` CSS variables.",
      },
    },
  },
  render: () => (
    <div className="w-full max-w-sm">
      ...
      >
        ...
        <p className="text-xs text-gray-600 dark:text-gray-300 leading-relaxed">
          Move your mouse — the spotlight follows via `--mouse-x` / `--mouse-y` CSS variables.
          Spotlight uses `--glow-indigo` at 6% opacity (12% in dark mode).
        </p>
        <div className="mt-4 flex gap-2">
...
export const AllVariants: StoryObj = {
  parameters: {
    docs: {
      description: {
        story: "Complete grid of all glass and surface variants for visual comparison.",
      },
    },
  },
  render: () => (
